...
void USTUPlayerHUDWidget::OnNewPawn(APawn* NewPawn)
{
	...
	if (HealthComponent && !HealthComponent->OnHealthChangend.IsBoundToObject(this))
	{
		HealthComponent->OnHealthChangend.AddUObject(this, &USTUPlayerHUDWidget::OnHealthChanged);
	}
	UpdateHealthBar();
}
