...
{
	UE_LOG(MyLogHealthComponent, Display, TEXT("On any damage: %f"), Damage);
}
	...
	UPrimitiveComponent* FHitComponent, FName BoneName, FVector ShotFromDirection, const UDamageType* DamageType, AActor* DamageCauser)
{
	...
	UE_LOG(
		MyLogHealthComponent, Display, TEXT("On point damage: %f, final damage: %f, bone: %s"), Damage, FinalDamage, *BoneName.ToString());
...
{
	UE_LOG(MyLogHealthComponent, Display, TEXT("On radial damage: %f"), Damage);
...
void USTUHealthComponent::SetHealth(float NewHealth)
{
	...
	Health = NextHealth;
	OnHealthChangend.Broadcast(Health, HealthDelta);
}
